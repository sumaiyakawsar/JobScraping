...
course_links_file_path = course_links_file_path.__str__() + '/LaTrobe_PG_links.txt'
course_links_file = open(course_links_file_path, 'r')

# the csv file we'll be saving the courses to
csv_file_path = Path(os.getcwd().replace('\\', '/'))
csv_file = csv_file_path.__str__() + '/LaTrobe_PG_unordered.csv'
...
for each_url in course_links_file:
    ...
    courses_details = soup.find_all("article", class_="PG")
    for ea in courses_details:
        ...
        # city atar
        cities = ea.select("article.PG.I .PG span:nth-of-type(n+2)")
        #print(cities)
        if cities:
        ...
        #print(actual_cities, course_data['Duration'], course_data['Duration_Time'],course_data['Career_Outcomes/path'], course_data['Website'])
...
ordered_file = csv_file_path.parent.__str__() + "/LaTrobe_PG_ordered.csv"
with open(csv_file, 'r', encoding='utf-8') as infile, \
            open(ordered_file, 'w', encoding='utf-8', newline='') as outfile:
