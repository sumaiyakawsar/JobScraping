...
faculty_key = {
    'Humanities, Arts, Social Sciences and Education': ['arts', 'family', 'history', 'teaching', 'criminology',
                                                        'education','historical', 'language','international','languages',
    ...
    'Science and Agriculture, Business and Law': ['legal','paralegal','science','accounting','agribusiness','agriculture','laws'
                                                  ,'law','animal','biomedical','business','physiology', 'exercise','commerce',
                                                  'computer','economics','environmental','geoscience','leadership',
                                                  'organisational','rural','scientific','zoology','agriculture','information',
                                                  'technology','data','cyber','disability','financial','human','resource','management'
                                                  'neuroscience',],
    'Medicine and Health': ['community services','medical','medicine','nursing','psychological','social','wellbeing',
                            'health','mental','counselling','psychology','pharmacy','philosophy','clinical']
    }