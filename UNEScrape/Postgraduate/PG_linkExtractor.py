...
result_elements = browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[3]/div[2]/div/div/table[4]')\
...
result_element = browser.find_element_by_xpath('/html/body/div[1]/div[3]/div[3]/div[2]/div/div/table[5]')\
        .find_element_by_tag_name('tbody').find_elements_by_tag_name('tr')
...
course_links_file_path = os.getcwd().replace('\\', '/') + '/UNE_PG_links.txt'
