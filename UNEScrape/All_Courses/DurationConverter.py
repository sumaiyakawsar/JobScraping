...
def convert_duration(duration):
    ...
    for word in duration.split():
        if 'semester' in word.lower() or 'trimester' in word.lower() or 'term' in word.lower() or 'hour' in word.lower() or 'day' in word.lower() or 'week' in word.lower() or 'month' in word.lower() or 'year' in word.lower():
