level_key = {'VOC': ['Vocational'],
             ...
             'FUG': ['FD', 'FDs', 'FDEd', 'FdEd', 'FdA', 'FDA', 'FDArts', 'FDEng', 'FdSc', 'A.A.', 'A.S.',
                     'A.A.S', 'A.A.S.'],
             'Found': ['Foundation','Preparation Program'],
             ...
             'SEMINAR': ['Seminar'], 'PRODEV': ['Tailor'], 'CONF': ['Conference'],
             'HONS': ['Honours', 'Hons']}

faculty_key = {
    'Humanities, Arts, Social Sciences and Education': ['arts', 'family', 'history', 'teaching', 'criminology',
                                                        'education', 'historical', 'language', 'international',
                                                        'languages',
                                                        'media', 'communications', 'music', 'social', 'sustainability',
                                                        'training', 'development', 'theatre', 'performance', 'urban',
                                                        'regional', 'educational', 'modern', 'communication', 'town',
                                                        'planning', 'education', 'linguistics', 'elearning', 'natural',
                                                        'hazards', 'educational', 'local', 'urban', 'philosophy'],
    'Science and Agriculture, Business and Law': ['legal', 'paralegal', 'science', 'accounting', 'agribusiness',
                                                  'agriculture', 'laws', 'law', 'animal', 'biomedical', 'business',
                                                  'physiology', 'exercise', 'commerce', 'computer', 'economics',
                                                  'environmental', 'geoscience', 'leadership', 'organisational',
                                                  'rural', 'scientific', 'zoology', 'agriculture', 'information',
                                                  'technology', 'data', 'cyber', 'disability', 'financial', 'human',
                                                  'resource', 'management', 'neuroscience', 'audiometry', 'prosecution',
                                                  'Advocacy'],
    'Medicine and Health': ['community services', 'medical', 'medicine', 'nursing', 'psychological', 'social',
                            'wellbeing', 'health', 'mental', 'counselling', 'psychology', 'pharmacy', 'philosophy',
                            'clinical'],
    'Learning and Teaching Transformation':['professional practice','pathways','preparation']
}
