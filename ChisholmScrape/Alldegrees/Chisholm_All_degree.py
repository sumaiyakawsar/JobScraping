...
for each_url in course_links_file:
    ...
    # print(index,course_data['Course'],course_data['Level_Code'],course_data['Website'],course_data['Course Delivery Mode'])
    ...
    # print(index,course_data['Description'],course_data['Website'])
    ...
    # print(index,course_data['Full_Time'],course_data['Part_Time'],course_data['Website'],course_data['Duration'],course_data['Duration_Time'] )
    ...
    if course_subject:
        ...
        t = 1
        for to in unit_desc:
            # course_subjects.append(to.text)
            course_data[f'Subject_Objective_{t}'] = to.text.strip()
            # print(t,course_data[f'Subject_Objective_{t}'])

            t = t + 1

    print(index, course_data['Website'])
