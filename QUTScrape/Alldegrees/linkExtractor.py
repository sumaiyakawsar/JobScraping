...
def course_add(sel):
    for ea in sel:
        ...
        course_name = ea.find_element_by_tag_name("p")
...
def courses(list_):
    for each_url in list_:
        ...
        # faculty = browser.find_element_by_css_selector(
        #    "body > div.header__wrapper > div > div.hero__header__container.container > h1 > span")
        # print(faculty.text + "\n")

        courses_col = browser.find_elements_by_css_selector(".open div.container")
        if courses_col:
